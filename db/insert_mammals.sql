...
INSERT INTO image_word (image_id, word_id, confidence) VALUES ( (SELECT id from images WHERE path='four_legged_mammal_2.jpeg'),(SELECT id from words  WHERE text_en='camel' ),  75 );
